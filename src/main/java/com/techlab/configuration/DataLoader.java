    ...
    public void run(String... args) {
        ...
        Product product1 = productRepository
                .save(Product.builder()
                        ...
                        .category(catLibros)
                        .stock(50)
                        .imageUrl("https://m.media-amazon.com/images/I/81mOclS-sKL.jpg")
                        .build());
        Product product2 = productRepository
                .save(Product.builder()
                        ...
                        .category(catVaritas)
                        .stock(20)
                        .imageUrl("https://m.media-amazon.com/images/I/61Z2C6K7SXL.jpg")
                        .build());
        Product product3 = productRepository
                .save(Product.builder()
                        ...
                        .stock(30)
                        .imageUrl("https://m.media-amazon.com/images/I/61p58z6i9+L.jpg")
                        .build());
        Product product4 = productRepository
                .save(Product.builder()
                        ...
                        .category(catJuegos)
                        .stock(15)
                        .imageUrl("https://m.media-amazon.com/images/I/81XzR-9XGkL.jpg")
                        .build());
        Product product5 = productRepository
                .save(Product.builder()
                        .name("Lámpara 3D: Las Reliquias de la Muerte")
                        .description("Impresión en PLA premium, luz LED cálida regulable.")
                        .price(7360f)
                        .category(catImpresiones)
                        .stock(10)
                        .imageUrl("https://m.media-amazon.com/images/I/61-sD-s6Y6L.jpg")
                        .build());
        Product product6 = productRepository
                .save(Product.builder()
                        ...
                        .category(catJuegos)
                        .stock(5)
                        .imageUrl("https://m.media-amazon.com/images/I/81C-S-S6Y6L.jpg")
                        .build());
        Product product7 = productRepository
                .save(Product.builder()
                        ...
                        .category(catVaritas)
                        .stock(15)
                        .imageUrl("https://m.media-amazon.com/images/I/61Y-S-S6Y6L.jpg")
                        .build());
        Product product8 = productRepository
                .save(Product.builder()
                        ...
                        .category(catJuegos)
                        .stock(40)
                        .imageUrl("https://m.media-amazon.com/images/I/61Z-S-S6Y6L.jpg")
                        .build());
        Product product9 = productRepository
                .save(Product.builder()
                        ...
                        .category(catImpresiones)
                        .stock(12)
                        .imageUrl("https://m.media-amazon.com/images/I/61A-S-S6Y6L.jpg")
                        .build());
        Product product10 = productRepository
                .save(Product.builder()
                        .name("Libro: Harry Potter y la Cámara Secreta")
                        .description("Continuación de las aventuras en Hogwarts. Edición especial.")
                        .price(28000f)
                        .category(catLibros)
                        .stock(40)
                        .imageUrl("https://m.media-amazon.com/images/I/81X-S-S6Y6L.jpg")
                        .build());
        Product product11 = productRepository
                .save(Product.builder()
                        .name("Anillo de la Familia Black")
                        .description("Joyería temática en plata con piedra negra y grabado antiguo.")
                        .price(1560f)
                        .category(catAccesorios)
                        .stock(8)
                        .imageUrl("https://m.media-amazon.com/images/I/61B-S-S6Y6L.jpg")
                        .build());
        Product product12 = productRepository
                .save(Product.builder()
                        ...
                        .category(catAccesorios)
                        .stock(25)
                        .imageUrl("https://m.media-amazon.com/images/I/61C-S-S6Y6L.jpg")
                        .build());
        Product product13 = productRepository
                .save(Product.builder()
                        ...
                        .stock(18)
                        .imageUrl("https://m.media-amazon.com/images/I/61D-S-S6Y6L.jpg")
                        .build());
        Product product14 = productRepository
                .save(Product.builder()
                        .name("Soporte 3D para Varitas")
                        .description("Diseño elegante en plástico negro mate para organizar tu colección.")
                        .price(1500f)
                        .category(catImpresiones)
                        .stock(20)
                        .imageUrl("https://m.media-amazon.com/images/I/61E-S-S6Y6L.jpg")
                        .build());
        Product product15 = productRepository
                .save(Product.builder()
                        .name("Libro: Harry Potter y el Prisionero de Azkaban")
                        .description("La historia se vuelve más oscura. Edición tapa dura.")
                        .price(23000f)
                        .category(catLibros)
                        .stock(30)
                        .imageUrl("https://m.media-amazon.com/images/I/81Y-S-S6Y6L.jpg")
                        .build());
