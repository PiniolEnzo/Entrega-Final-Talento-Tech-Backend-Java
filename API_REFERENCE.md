# TechLab API Reference

> Complete API reference for the TechLab e-commerce backend.
...
Swagger:  http://localhost:8080/swagger-ui      (ADMIN only)
API Docs: http://localhost:8080/v3/api-docs     (ADMIN only)
```
